...
function generatePassword(){
  ...
  var password="";
    ...
    while(counter<passwordArr.length){
      ...
      if(lowerCase){
      passwordArr[Math.floor(Math.random()*passwordArr.length)]=lowerCaseArr[Math.floor(Math.random()*lowerCaseArr.length)];
      counter++;
      }
      //create random uppercase letter in random position
      if(upperCase){
        passwordArr[Math.floor(Math.random()*passwordArr.length)]=upperCaseArr[Math.floor(Math.random()*upperCaseArr.length)];
      counter++;
      }
      //create random number in random position
      if(numeric){
        passwordArr[Math.floor(Math.random()*passwordArr.length)]=numArr[Math.floor(Math.random()*numArr.length)];
      counter++;
      }
      //create random special character in random position
      if(specialChar){
        passwordArr[Math.floor(Math.random()*passwordArr.length)]=specialCharArr[Math.floor(Math.random()*specialCharArr.length)];
      counter++;
      }
    }
